...
function cursorAnimation(){
    ...
    //SETTING TEXT TO THE SOCIAL MEDIA ICONS FIXED ON THE PAGE
    document.querySelector('#instagramSocialLinks').addEventListener('mouseenter',()=>{
        cursor.setText('instagram')
    })
    document.querySelector('#instagramSocialLinks').addEventListener('mouseleave',()=>{
    ...
    //adding image when hovering over the instagram link
    ContactSectioninstagram .addEventListener('mouseenter', () => {
        cursor.setImg('images/instagramimage.png')
    });
